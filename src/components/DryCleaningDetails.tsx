    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-5xl mx-auto py-12 px-4">
        <div className="text-center text-white">
          <h1 className="text-4xl font-bold">Dry Cleaning</h1>
          <p className="mt-2 text-lg max-w-xl mx-auto">
            Expert care for delicate and luxury fabrics.
          </p>
        </div>

        <div className="mb-8 text-center">
          <p className="text-gray-700 leading-relaxed max-w-3xl mx-auto text-lg">
            Our dry cleaning service uses state-of-the-art solvents to clean
            your delicate garments without water, preserving texture and color.
            Perfect for woolens, silks, suits, and traditional Kashmiri attire.
          </p>
        </div>
        ...
        <div className="mt-12 bg-blue-50 border border-blue-200 rounded-lg p-6 flex items-center gap-4">
          ...
          <p className="text-blue-900 font-medium">
            Delicate fabric care with gentle solvents for a spotless finish.
          </p>
        </div>
...
export default DryCleaningDetails;
